...
class BinaryPt1 {
    private countingState = 0;
    private countingTimeout: number;
    ...
    getDigits(): NodeListOf<HTMLTableCellElement> {
        return document.querySelectorAll('.digit');
    }

    getButton(): HTMLButtonElement {
        return document.getElementById('start-counting') as HTMLButtonElement;
    }
